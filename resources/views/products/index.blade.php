                ...
                <div class="modal-body">
                    <form method="POST" action="{{route('products.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <br>
                            <a href="#"><button class="btn btn-info btn-sm" type="button">+ Agregar Autores</button></a>
                        </div>
                        <div class="mb-3">
                            ...
                            <br>
                            <a href="{{route('workshop.index')}}"><button class="btn btn-info btn-sm" type="button">+ Agregar Taller</button></a>
                        </div>
                        <div class="mb-3">
