                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="Whatsapp" aria-describedby="Whatsapp" name="whatsapp"
                                       placeholder="4274277211" value="{{old('whatsapp',$home->whatsapp)}}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="email" aria-describedby="email" name="email"
                                       placeholder="espresso@gmail.com" value="{{old('email',$home->email)}}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control" id="phone_1" aria-describedby="Teléfono 1" name="phone_1"
                                       placeholder="4424365663" value="{{old('phone_1',$home->phone_1)}}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="mobile_1">Celular 1:</label>
                                <input type="number" class="form-control" id="mobile_1" aria-describedby="Mobil 1" name="mobile_1"
                                       placeholder="4424327291" value="{{old('mobile_1',$home->mobile_1)}}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="mobile_2">Celular 2:</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="facebook" aria-describedby="facebook" name="facebook"
                                       placeholder="https://www.facebook.com/casa-loohl" value="{{old('facebook',$home->facebook)}}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="instagram" aria-describedby="instagram" name="instagram"
                                       placeholder="https://www.instagram.com/casa_loohl" value="{{old('instagram',$home->instagram)}}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="spotify" aria-describedby="spotify" name="spotify"
                                       placeholder="https://open.spotify.com/show/casa_loohl" value="{{old('spotify',$home->spotify)}}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="medium" aria-describedby="medium" name="medium"
                                       placeholder="https://medium.com/@casa_loohl" value="{{old('medium',$home->medium)}}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="linkedin" aria-describedby="linkedin" name="linkedin"
                                       placeholder="https://linkedin.com/in/casa-loohl" value="{{old('linkedin',$home->linkedin)}}">
                            </div>
                        </div>
                    </div>
