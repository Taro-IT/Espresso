        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up">Ofreciendo la <l class="text-purple">atención</l> que personas con <l class="text-purple">enfermedades mentales merecen</l></h1>
                    <h2 data-aos="fade-up" data-aos-delay="400">Somos un puente entre la hospitalización y la reinserción social </h2>
            ...
            <div class="container" data-aos="fade-up">
                <div class="row gx-0">
                    ...
                    <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up"
                         data-aos-delay="200">
                        <div class="content">
                            <h1>Brindamos un espacio apto para el <l class="text-purple">crecimiento personal de personas con trastornos psicosociales</l>.</h1>
                            <p>
                               Ayudamos a nuestros huéspedes a tener una mejor calidad de vida con modelo terapéutico innovador.
                            </p>
                            <div class="text-center text-lg-start">
                                <a href="#"
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="box" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <p>Restablecer los vínculos interpersonales de los huéspedes y bridarles herramientas que les
                                permitan
                    ...
                    <div class="col-lg-12 mt-12 mt-lg-12">
                        <div class="box" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum a egestas turpis, quis
                    ...
                    <div class="col-lg-12 mt-12 mt-lg-12">
                        <div class="box" data-aos="fade-up" data-aos-delay="600">
                            ...
                            <p>Explore nuestra colección de artículos de divulgación, producciones literarias, producciones
                            ...
                            <div class="row align-self-center gy-4">
                                ...
                                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="400">
                                    ...
                                    <div>
                                        ...
                                        <p>Et fuga et deserunt et enim. Dolorem architecto ratione tensa raptor
                                            marte</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="500">
                                    ...
                                    <div>
                                        ...
                                        <p>Est autem dicta beatae suscipit. Sint veritatis et sit quasi ab aut
                                            inventore</p>
                                    </div>
                                </div>
